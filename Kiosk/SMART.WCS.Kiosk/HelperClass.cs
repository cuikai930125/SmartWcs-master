...
using static SMART.WCS.Kiosk.uKioskMsgBox;
...
namespace SMART.WCS.Kiosk
{
    public class HelperClass : IDisposable
    {
        ...
        /// </summary>
        /// <param name="_strMessageResourceCode">메세지 리소스 코드</param>
        public static void MsgError(string _strMessageResourceCode)
        {
            MsgError(_strMessageResourceCode, string.Empty);
        }
        #endregion
        ...
        /// <param name="_strMessageResourceCode">메세지 리소스 코드</param>
        /// <param name="_strConditionValue">멀티 항목 조건값</param>
        public static void MsgError(string _strMessageResourceCode, string _strConditionValue)
        {
            string strMessage   = string.Empty;
            ...
            using (uKioskMsgBox frmError = new uKioskMsgBox(strMessage, MsgBoxKind.Error))
            {
                frmError.ClickResult += FrmMsgBox_ClickResult;
                frmError.ShowDialog();   
            }
