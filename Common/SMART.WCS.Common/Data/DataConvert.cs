...
namespace SMART.WCS.Common.Data
{
    public class DataConvert
    {
        ...
        public static void ImageSource(System.Windows.Controls.Image _imageCtrl, string _strImageUrl)
        {
            try
            {
                BitmapImage bi                          = new BitmapImage();
                bi.BeginInit();
                bi.UriSource                            = new Uri(_strImageUrl, UriKind.Relative);
                bi.EndInit();
                _imageCtrl.Stretch                      = Stretch.Fill;
                _imageCtrl.Source                       = bi;
            }
            catch { throw; }
        }
        #endregion
