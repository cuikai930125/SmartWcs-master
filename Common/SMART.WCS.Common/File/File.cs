    ...
    public class File : DisposeClass
    {
        ...
        public static void CompressToZip(string _strSourcePath, string _strZipPath)
        {
            try
            {
                ...
                using (FileStream fs = new FileStream(_strZipPath, FileMode.Create, FileAccess.Write))
                {
        ...
        //private static void DeleteFile(string _strPath)
        //{
        //    //FileInfo fi = new FileInfo(_strPath);
