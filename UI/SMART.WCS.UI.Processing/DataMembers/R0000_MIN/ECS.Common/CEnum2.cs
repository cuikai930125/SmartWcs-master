...
namespace SMART.WCS.UI.Processing.DataMembers.R0000_MIN.ECS.Common
{
    public class CEnum2
    {
        ...
        {
            TestImportLoadingSend = 10,
            TestImportUnloadingSend = 20,
            TestReleaseLoadingSend = 30,
            TestReleaseUnloadingSend = 40,
            TestAIScan = 900,
            TestInducted = 1000,
            TestIPSScan = 1001,
            TestDischarged = 1002,
