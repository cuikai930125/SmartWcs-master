...
using SMART.WCS.UI.Processing.DataMembers.R1005_GAN;
using System;
...
{
    /// <summary>
    /// Processing > Smart Gantry > 입고 작업조회
    /// </summary>
    public partial class R1005_GAN : UserControl
    {
        #region ▩ Detegate 선언
        ...
        public static readonly DependencyProperty WrkListProperty
            = DependencyProperty.Register("WrkList", typeof(ObservableCollection<WrkInfo>), typeof(R1005_GAN)
        ...
        public static readonly DependencyProperty GridRowCountProperty
            = DependencyProperty.Register("GridRowCount", typeof(string), typeof(R1005_GAN), new PropertyMetadata(string.Empty));
        ...
        public R1005_GAN(List<string> _liMenuNavigation)
        {
            try
            {
                InitializeComponent();
        ...
        #region ▩ 이벤트
        #region > Loaded 이벤트
        private void R1005_GAN_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                if (FirstLoad)
        ...
        #region >> GetSP_WRK_SEARCH - 입고 작업 리스트 조회
        /// <summary>
        /// 입고 작업 리스트 데이터조회
        /// </summary>
        private DataSet GetSP_WRK_SEARCH()
        {
            ...
            var strProcedureName = "PK_R1005_GAN.SP_WRK_SEARCH";
            ...
            var strFrWrkYmd = this.BaseClass.GetCalendarValue(this.deFrWrkYmd);                                     // 시작 입고 작업 번호
            var strToWrkYmd = this.BaseClass.GetCalendarValue(this.deToWrkYmd);                                     // 종료 입고 작업 번호
            var strBtchNo = this.txtBatchNo.Text.Trim();   // 배치번호
            var strGanWrkStatCd = this.BaseClass.ComboBoxSelectedKeyValue(this.cboGanWorkState);     // 입고 작업 상태
