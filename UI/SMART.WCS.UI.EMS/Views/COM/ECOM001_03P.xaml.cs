...
{
    /// <summary>
    /// ECOM001_03P.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ECOM001_03P : Window, IDisposable
    {
        #region ▩ Delegate
        ...
        public ECOM001_03P()
        {
            try
            {
                ...
                gridChkListView.ShowingEditor += (s, e) =>
                {
                    e.Cancel = gridChkList.CurrentColumn.FieldName != "IsChecked";
                };

                btnFormClose.Click += btnFormClose_Click;

                this.Loaded += ECOM001_03P_Loaded;
            }
            catch (Exception err)
            {
        ...
        #region ▩ 속성
        public ObservableCollection<EmsChkList> CurrChkList { get; private set; }
        #endregion
        ...
        void ChkListSearch()
        {
            try
            {
                ...
                string callProc = "PK_EMS_ECOM01_03P.SP_EMS_CHECK_LIST_SEARCH";
                ...
                using (BaseDataAccess da = new BaseDataAccess())
                {
                    ...
                    CurrChkList = new ObservableCollection<EmsChkList>();

                    if (outData.Tables[0].Rows.Count > 0)
                    {
                        CurrChkList.ToObservableCollection(outData.Tables[0]);
                    }

                    gridChkList.ItemsSource = null;
                    gridChkList.ItemsSource = CurrChkList;
                }
            }
            catch (Exception ex)
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ECOM001_03P_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                this.Loaded -= ECOM001_03P_Loaded;
